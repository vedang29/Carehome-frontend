...
export default function SearchBar() {
  ...
  return (
    <>
      <div className="hidden md:flex items-center gap-3 bg-white rounded-full w-full justify-between ">
        {/* Location Input */}
      ...
      {/*For mobile Screens */}
      <div className="md:hidden w-full max-w-md bg-muted px-4 py-2 rounded-xl flex items-center justify-between">
