...
const AboutCard = () => {
  return (
    <div className="flex flex-col items-center text-center border-card w-96 p-10 rounded-xl gap-10 mt-20">
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-600 leading-relaxed line-clamp-3 text-justify mt-10">
